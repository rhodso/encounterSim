...
class roll {
 public:
  ...
  roll();
  roll(int _diceToRoll,
       int _diceType);  // Modifier defaults to 0 if left unspecified
  ...
  // Methods to roll the dice without creating object. Modifier defaults to 0 if
  // left unspecified
